...
// see https://github.com/twbs/bootstrap/issues/23381#issuecomment-330850892
// see https://stackoverflow.com/questions/46004087/issue-loading-popperjs-and-bootstrap-via-requirejs-even-after-using-recommended#answer-46324042
define("initBootstrap", ["popper"], function(popper) {
	// set up popper as required by Bootstrap
	window.Popper = popper;
	require(["bootstrap"], function(bootstrap) {
		// do nothing - just initialise Bootstrap
	});
});
